...
app.client.request = function(headers,path,method,queryStringObject,payload,callback){
	console.log( '[ app.client.request ] - client.request START' );
	...
	console.log( '[ scripts.client.request ] - headers: ', headers );
	console.log( '[ scripts.client.request ] - method: ', method );
	console.log( '[ scripts.client.request ] - path: ', path );
	console.log( '[ scripts.client.request ] - payload: ', payload );
	console.log( '[ scripts.client.request ] - queryStringObject: ', queryStringObject );
	console.log( '[ scripts.client.request ] - requestUrl: ', requestUrl );
	...
	for(let headerKey in headers){
		console.log( '[ app.client.request ] - headerKey: ', headerKey );
		if(headers.hasOwnProperty(headerKey)){
			xhr.setRequestHeader(headerKey, headers[headerKey]);
			console.log( '[ app.client.request ] - headers[ headerKey ]: ', headers[ headerKey ] );
		}
	}
	...
	console.log( '[ scripts.app.client.request.xhr ] - app.config: ', app.config );
	console.log( '[ scripts.app.client.request.xhr ] - xhr1: ', xhr );
	...
	xhr.onreadystatechange = function() {
		if(xhr.readyState === XMLHttpRequest.DONE) {
			...
			console.log( '[ scripts.app.client.request.xhr.onreadystatechange ] - responseReturned: ', responseReturned );
	...
	console.log( '[ scripts.app.client.request.xhr ] - xhr2: ', xhr );
...
app.bindLogoutButton = function(){
	console.log( '[ app.bindLogoutButton ] - app.bindLogoutButton START' );
...
app.logUserOut = function(redirectUser){
	console.log( '[ app.logUserOut ] - app.logUserOut START' );
...
app.bindForms = function(){
	console.log( '[ app.bindForms ] - app.bindForms START' );
...
app.formResponseProcessor = function(formId,requestPayload,responsePayload){
	console.log( '[ app.formResponseProcessor ] - app.formResponseProcessor START' );
...
app.getSessionToken = function(){
	console.log( '[ app.getSessionToken ] - app.getSessionToken START' );
...
app.setLoggedInClass = function(add){
	console.log( '[ app.setLoggedInClass ] - app.setLoggedInClass START' );
...
app.setSessionToken = function(token){
	console.log( '[ app.setSessionToken ] - app.setSessionToken START' );
	console.log( '[ app.setSessionToken ] - token: ', token );
	app.config.sessionToken = token;
...
app.renewToken = function(callback){
	console.log( '[ app.renewToken ] - app.renewToken START' );
...
app.loadDataOnPage = function(){
	console.log( '[ app.loadDataOnPage ] - app.loadDataOnPage START' );
...
app.loadAccountEditPage = function(){
	console.log( '[ app.loadAccountEditPage ] - app.loadAccountEditPage START' );
...
app.loadChecksListPage = function(){
	console.log( '[ app.loadChecksListPage ] - app.loadChecksListPage START' );
	// Get the phone number from the current token, or log the user out if none is there
	let phone = typeof(app.config.sessionToken.phone) === 'string' ? app.config.sessionToken.phone : false;
	if(phone){
		// Fetch the user data
...
app.loadChecksEditPage = function(){
	console.log( '[ app.loadChecksEditPage ] - app.loadChecksEditPage START' );
...
app.tokenRenewalLoop = function(){
	console.log( '[ app.tokeRenewalLoop ] - app.tokenRenewalLoop START' );
...
// Init (bootstrapping)
app.init = function(){
	console.log( '[ app.init ] - app.init START' );
